...
class Collections_balanceController extends Controller
{
    public function index($account, $filter = null, $paper_id = null){
        if(!Auth::user()->can('collections_balance_read')){
        ...
        $view = (isset($preview[1]) && $preview[1] == 1)? 'preview_list' : 'index';
            ...
            return view('dashboard.collections_balance.'.$view, compact(
                'collections',
                'papers',
                'paper',
                'dt_from',
