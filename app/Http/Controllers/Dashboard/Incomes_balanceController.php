...
class Incomes_balanceController extends Controller
{
    public function index($account, $filter = null, $paper_id = null){
        ...
        $incomes = DB::table('income_bulletins')
        ...
        $view = (isset($preview[1]) && $preview[1] == 1)? 'preview_list' : 'index';
            ...
            return view('dashboard.incomes_balance.'.$view, compact(
                'incomes',
                'papers',
                'paper',
                'dt_from',
