...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="row">
                <div class="col-sm-12">
                    <h1 style="margin-bottom: 10px"><i class="fa fa-university"></i>  مركز التكلفة لمالك الشركة</h1>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-body with-border" style="min-height: 600px">
                    <div class="row">
                        <div class="col-sm-8 search_inline">
                            <label>العميل</label>
                        ...
                        <div class="col-sm-4 text-left">
                            <button type="button" class="btn btn-primary btn-block" onclick="loadCustomerCost(1)"> <i class="fa fa-eye"></i> عرض التقرير</button>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-left">
                                    <button type="button" class="btn btn-primary btn-block" onclick="loadCustomerCost()"> <i class="fa fa-eye"></i> عرض التقرير</button>
                                </div>
                            </div>
                        </div>
                        -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h3 id="customers_payments_total" class="currency">0.00</h3>
                                    <p>اجمالي التحصيل من العميل</p>
                                </div>
                                <div class="icon">
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6">
                                    <div class="small-box bg-red-gradient">
                                        <div class="inner">
                                            <h3 id="payed_taxes_total" class="currency">0.00</h3>
                                            <p>مجموع الضرائب المسددة عن العميل</p>
                                        </div>
                                        <div class="icon">
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <div class="small-box bg-orange">
                                        <div class="inner">
                                            <h3 id="sellers_payments_total" class="currency">0.00</h3>
                                            <p>اجمالي مصروفات المسوقين </p>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-ios-list"></i>
                                        </div>
