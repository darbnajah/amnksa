            ...
            <tr row_id="{{ $deduction->id }}" type="deduction">
                <td class="table_actions">
                    <?php if($deduction->debit > 0): ?>
                        ...
                        <button type="button" class="btn_remove btn btn-danger" onclick="removeDeductionAdvanceRow('{{ route('dashboard.deductions_advances.delete', $deduction->id) }}')"><i class="fa fa-times"></i></button>
                        @endif
                    <?php endif; ?>
                </td>
