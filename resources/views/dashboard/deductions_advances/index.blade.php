                ...
                <div class="box-body with-border">
                    <div class="row">
                        <div class="col-sm-6 search_inline">
                            <label>الموظف</label>
                            <input type="hidden" id="employee_id" value="{{ isset($employee_id)? $employee_id : null }}" readonly>
                            <input type="text" id="employee_name" value="{{ isset($employee_name)? $employee_name : null }}" readonly>
                            <button type="button" class="btn btn-default" onclick="modalEmployees('{{ route('dashboard.employees.modal', 'deductions_advances') }}')"><i class="fa fa-search"></i></button>

                        </div>
                    </div>
                </div>
            </div>
            <div class="box box-primary deductions_advances_wrap" style="display: {{ isset($employee_id)? 'block' : 'none' }}">
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="panel panel-warning">
                                <div class="panel-heading">
                                    <span>السلف</span>
                                    @if(!Session::has('expiration_dt') && auth()->user()->can('deductions_advances_create'))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="pull-left">
                    <button type="button" class="btn_pay_invoice btn btn-warning btn-lg" onclick="saveDeductionsAdvance('{{ route('dashboard.deductions_advances.store') }}', 'advance')"><i class="fa fa-save"></i> حفظ</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="pull-left">
                    <button type="button" class="btn_pay_invoice btn btn-danger btn-lg" onclick="saveDeductionsAdvance('{{ route('dashboard.deductions_advances.store') }}', 'deduction')"><i class="fa fa-save"></i> حفظ</button>
                </div>
            </div>
        </div>
    </div>
