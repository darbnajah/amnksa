...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="row">
                <div class="col-md-6">
                    <h1><i class="fa fa-university"></i> كشف حساب المصروفات</h1>
                </div>
        ...
        <section class="content">
            <input type="hidden" id="route_url" class="form-control" value="{{ url('/dashboard/expenses_balance/') }}">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-hover">
                                ...
                                <?php foreach($expenses as $expense){
                                    ...
                                    <tr>
                                        <td>{{ $expense->dt }}</td>
                                        <td width="50%">{{ $expense->label }}</td>
                                        <td class="currency bold">{{ \App\Helper\Helper::nFormat($expense->amount) }}</td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                                <tfoot>
