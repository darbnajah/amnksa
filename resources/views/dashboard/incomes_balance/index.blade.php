...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="row">
                <div class="col-md-6">
                    <h1><i class="fa fa-university"></i> كشف حساب الإيرادات الإضافية</h1>
                </div>
        ...
        <section class="content">
            <input type="hidden" id="route_url" class="form-control" value="{{ url('/dashboard/incomes_balance/') }}">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-hover">
                                ...
                                <?php foreach($incomes as $income){
                                    ...
                                    <tr>
                                        <td>{{ $income->dt }}</td>
                                        <td width="50%">{{ $income->label }}</td>
                                        <td class="currency bold">{{ \App\Helper\Helper::nFormat($income->amount) }}</td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                                <tfoot>
