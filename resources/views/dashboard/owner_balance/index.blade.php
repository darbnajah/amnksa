                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="small-box bg-red">
                                        <div class="inner">
                                            <p>مشتريات ومصروفات</p>
                                            <h3 class="currency">{{ $obj->purchases_and_expenses_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                                    ...
                                    <div class="small-box bg-lime-active">
                                        <div class="inner">
                                            <p>خصم المسوقين	</p>
                                            <h3 class="currency">{{ $obj->sellers_deductions_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="small-box bg-red">
                                        <div class="inner">
                                            <p>الضرائب المدفوعة</p>
                                            <h3 class="currency">{{ $obj->payed_taxes_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="small-box bg-yellow">
                                        <div class="inner">
                                            <p>الضرائب الغير مدفوعة</p>
                                            <h3 class="currency">{{ $obj->not_payed_taxes_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="small-box bg-red">
                                        <div class="inner">
                                            <p>مدفوعات المسوقين</p>
                                            <h3 class="currency">{{ $obj->transfered_sellers_payments_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                                    ...
                                    <div class="small-box bg-red">
                                        <div class="inner">
                                            <p>سلف المسوقين	</p>
                                            <h3 class="currency">{{ $obj->sellers_advances_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                                    ...
                                    <div class="small-box bg-yellow">
                                        <div class="inner">
                                            <p>نسب المسوقين غير مدفوعة</p>
                                            <h3 class="currency">{{ $obj->accepted_not_payed_sellers_payments_total }}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-document-text"></i>
                                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="small-box bg-primary">
                                <div class="inner">
                                    ...
                                    <h3 class="currency">{{ $obj->owner_balance_net }}</h3>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-document-text"></i>
                                </div>
