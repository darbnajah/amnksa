            ...
            <tr row_id="{{ $advance->id }}" type="advance">
                <td class="table_actions">
                    <?php if($advance->debit > 0): ?>
                        ...
                        <button type="button" class="btn_remove btn btn-danger" onclick="removeDeductionAdvanceRow('{{ route('dashboard.sellers_deductions_advances.delete', $advance->id) }}')"><i class="fa fa-times"></i></button>
                        @endif
                    <?php endif; ?>
                </td>
